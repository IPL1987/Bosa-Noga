        ...
        <div className="col">
          <section>
            ...
            <ul className="nav flex-column">
              <Link to="/about" className="nav-link"><li className="nav-item">О магазине</li></Link>
              <Link to="/catalog" className="nav-link"><li className="nav-item">Каталог</li></Link>
              <Link to="/contacts" className="nav-link"><li className="nav-item">Контакты</li></Link>
            </ul>
          </section>
        </div>
        <div className="col">
